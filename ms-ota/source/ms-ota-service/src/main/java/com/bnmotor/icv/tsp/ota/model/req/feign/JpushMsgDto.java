...
public class JpushMsgDto {
     ...
     * 是否推送给全部用户标记位
     */
    @ApiModelProperty(value = "是否推送给全部用户标记位", name = "sendAllFlag", required = true)
     ...
     */
    @ApiModelProperty(value = "发送标签列表[标签列表tags，一次推送最多 1000 个，和sendRegistrationId只能二选一 同时填只有一个生效]", name = "sendTagsList")
