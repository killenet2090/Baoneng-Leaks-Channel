...
public class FotaFirmwareDto extends AbstractBase {
    ...
    @ApiModelProperty(value = "刷写脚本URL", example = "www.baidu.com", required = true)
    ...
    @ApiModelProperty(value = "信息采集受控对象:0=Master, 1=Slave-HMI", example = "0", required = true)
    private Integer infoCollCtrlObj;

    @ApiModelProperty(value = "下载受控对象:0=Master", example = "0", required = true)
    private Integer dlCtrlObj;

    @ApiModelProperty(value = "安装传输受控对象:0=Master, 1=Slave-HMI", example = "0", required = true)
    private Integer instTxCtrlObj;

    @ApiModelProperty(value = "安装受控对象:0=Master, 1=Slave-HMI", example = "0", required = true)
    private Integer instCtrlObj;

    @ApiModelProperty(value = "安装约束（零件需要处于低压或高压条件下才可以安装）:0=低压 1=高压", example = "1", required = true)
    private Integer instCondition;

    @ApiModelProperty(value = "总线类型:0=ETH, 1=CAN, 2=ETH/CAN", example = "0", required = true)
