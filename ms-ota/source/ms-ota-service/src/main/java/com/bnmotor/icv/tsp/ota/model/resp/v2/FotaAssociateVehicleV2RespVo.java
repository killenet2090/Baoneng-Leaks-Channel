...
@Data
public class FotaAssociateVehicleV2RespVo extends Page<FotaAssociateVehicleVo> {
	...
	public static FotaAssociateVehicleV2RespVo wrap(Page<FotaAssociateVehicleVo> page) {
		FotaAssociateVehicleV2RespVo fotaPlanVehicleStateV2RespVo = FotaAssociateVehicleV2RespVo.of();
		...
		Long validCount = page.getRecords().stream().filter(it -> it.getCanAssociate() == VehicleAssociateStateEnum.CAN_ASSOCIATE.getType()).count();
...
//	 */
//	public void manualPage(QueryUpgradeObjectV2Req vehicleUploadFileV2Req) {
//		
