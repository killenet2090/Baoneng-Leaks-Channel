...
public interface IFotaPlanTaskDetailService{
    /**
     ...
     * @return
     */
    //List<FotaPlanTaskDetailPo> getByOtaPlanObjIdWithPlanFirmwareId(Long otaPlanObjectId, List<Long> planFirmwareIds);
     ...
     * @return
     */
    //List<FotaPlanTaskDetailPo> getByOtaPlanObjId(Long otaPlanObjectId);
     ...
     * @return
     */
    List<TaskFailStatisticsVo> taskFailStatistics(TaskFailStatisticsFilterReq req);
     ...
     * @return
     */
    Map<String, Object> getPlanTaskDetails(TaskMonitoriedECUReq req);
}
