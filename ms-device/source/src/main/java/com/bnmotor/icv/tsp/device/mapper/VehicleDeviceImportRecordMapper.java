...
import com.bnmotor.icv.tsp.device.model.entity.VehicleDeviceImportRecordPo;
...
@Mapper
public interface VehicleDeviceImportRecordMapper extends AdamMapper<VehicleDeviceImportRecordPo> {
    /**
     * 根据任务号批量删除任务
     *
     * @param taskNo 任务号
     ...
     * @return 车辆设备导入记录
     */
    List<VehicleDeviceImportRecordPo> listByTaskNoAndStatus(@Param("vins") Collection<String> vins,
