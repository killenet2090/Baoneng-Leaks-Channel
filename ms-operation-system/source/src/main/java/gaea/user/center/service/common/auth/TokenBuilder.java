...
public class TokenBuilder
{
    ...
    public static final long  DEFAULT_TOKEN_EXPIRE_TIME  = 60 * 60 * 24 * 1000;
    ...
    public static TokenDTO getDefaultTokenDTO(Long expireTime)
    {
        TokenDTO tokenDTO = new TokenDTO();
        tokenDTO.setIssuedAt(new Date());
        tokenDTO.setExpireTime(expireTime);
        tokenDTO.setRefreshTokenTime(expireTime*2);
        if(null == tokenSecret)
        {
            return null;
        }
