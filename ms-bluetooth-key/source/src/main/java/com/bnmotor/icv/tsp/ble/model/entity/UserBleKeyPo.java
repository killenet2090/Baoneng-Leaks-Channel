...
@Data
@Builder
@TableName("tb_user_ble_key")
public class UserBleKeyPo implements Serializable {
    ...
    /**
     * 操作类型
     1:表示新增加：2表示手动删除；3：表示到期删除；4：离线删除；5：表示手动更新；6：表示卸载后更新
     */
