...
public class TemplateMsgDto {
     ...
     */
    @ApiModelProperty(value = "来源终端类型 0后台管理平台 1-app 2-车机 3-tbox  6-蓝牙钥匙", name = "fromType", required = true, example = "3")
     ...
     */
    @ApiModelProperty(value = "映射模板id 1-用户注册验证码 2-发送锁车/解车验证码 3-发送熄火后锁定 4-告知用户车辆已锁定  5-短信告知被授权用户授权码和app下载url", name = "mappingTemplateId", required = true, example = "1")
